...
int main()
{
    ...
    g1.hand[player][handPos] = village;
    g1.handCount[player] = 1;
    g1.deck[player][0] = copper;
    ...
    assertEquals(result, 0, "village: Successfully returned with 0.");
    assertEquals(g1.playedCardCount, 1, "village: Played card pile contains 1 card.");
    assertEquals(g1.handCount[player], 1, "village: Player hand contains 1 card.");
    assertEquals(g1.hand[player][0], copper, "village: Player hand position 1 contains copper.");
    assertEquals(g1.numActions, 2, "village: numActions increased to 2.");
    ...
    g2.playedCards[0] = village;

    g2.deckCount[player] = 0;
    g2.deck[player][0] = copper;

    g2.numActions = 2;
    
    // Compare g1 and g2 to ensure no unexpected changes
    assertEquals(deepEquals(g1, g2), 1, "village: No other changes to gameState.");
