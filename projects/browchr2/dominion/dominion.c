...
void playAdventurer(int, int, struct gameState*, int, int*);
void playSmithy(int, int, struct gameState*);
void playVillage(int, int, struct gameState*);
void playGreatHall(int, int, struct gameState*);
void playCouncilRoom(int, int, struct gameState*);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus) {
    ...
    switch (card) {
        case adventurer:
            playAdventurer(drawntreasure, currentPlayer, state, z, temphand);
            return 0;
...
void playAdventurer(int drawntreasure, int currentPlayer, struct gameState *state, int tempCounter, int *temphand) {
    while (drawntreasure < 2) {
        // Shuffle discard if deck is empty
...
void playVillage(int handPos, int currentPlayer, struct gameState *state) {
    // +1 Card
    drawCard(currentPlayer, state);
...
void playGreatHall(int handPos, int currentPlayer, struct gameState *state) {
    // +1 Card
    drawCard(currentPlayer, state);
...
void playCouncilRoom(int handPos, int currentPlayer, struct gameState *state) {
    int i;
