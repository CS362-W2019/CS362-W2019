...
int adventurerFunc(int drawntreasure, int currentPlayer, struct gameState *state, int temphand[], int z)
{
	//bug
	z += 1;
	int cardDrawn;
...
int minionFunc(struct gameState *state, int handPos, int currentPlayer, int choice1, int choice2)
{
	int i;
	int j;
	//+1 action
...
int feastFunc(struct gameState *state, int temphand[], int choice1, int currentPlayer)
{
	int x;
	int i;
...
int mineFunc(int choice2, int choice1, int currentPlayer, struct gameState *state, int handPos)
{
	int j;
	int i;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
	case adventurer:
      return adventurerFunc(drawntreasure, currentPlayer, state, temphand, z);
    ...
    case feast:
		return feastFunc(state, temphand, choice1, currentPlayer);
			
    case gardens:
      return -1;
			
    case mine:
		return mineFunc(choice2, choice1, currentPlayer, state, handPos);
    ...
    case minion:
		return minionFunc(state, handPos, currentPlayer, choice1, choice2);
    case steward:
      if (choice1 == 1)
	{
	  //+2 cards
