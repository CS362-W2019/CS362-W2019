...
void greatHallFunc(int currentPlayer, struct gameState *state,
                   int handPosition) {
  // no bug implemented for this function
...
void villageFunc(int currentPlayer, struct gameState *state, int handPosition) {
  // implement bug --
  // Switch the  drawings of actions and cards
  // +2 cards
  // +1 actions
...
void smithyFunc(int currentPlayer, struct gameState *state, int handPosition) {
  // implement bug --
  // draw 4 cards isntead of 3
  int NUM_CARDS = 4;
...
void adventurerFunc(int drawntreasure, int currentPlayer,
                    struct gameState *state, int *temphand, int z,
                    int cardDrawn) {
  // implement bug --
  // reveal cards until you receive 1 treasure card instead of 2 treasure cards
  int NUM_TREASURE_CARDS = 1;

  while (drawntreasure < NUM_TREASURE_CARDS) {
...
void councilRoomFunc(int currentPlayer, struct gameState *state,
                     int handPosition) {
  // implement bug --
...
int cardEffect(int card, int choice1, int choice2, int choice3,
  ...
  case adventurer:
    ...
    adventurerFunc(drawntreasure, currentPlayer, state, temphand, z, cardDrawn);
    return 0;

  case council_room:

    councilRoomFunc(currentPlayer, state, handPos);
    return 0;
