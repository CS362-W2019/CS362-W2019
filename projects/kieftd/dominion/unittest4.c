...
*  File: cardtest4.c testing Adventurer
*
* 
...
int main() {
	...
	//cardEffect(steward, choice1, choice2, choice3, &actualG, handpos, &bonus);
    ref_adventurer(&G, handpos, &bonus, drawntreasure);
...
if (G.coins > testG.coins)  //Should have 2-6 more coins
    {
