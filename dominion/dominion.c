...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    return aventurerFun(currentPlayer, state);
    ...
    return smithyFun(currentPlayer, state, handPos);
	...
	return stewardFun(currentPlayer, state, choice1, choice2, choice3, handPos);
    ...
    return cutpurseFun(currentPlayer, state, handPos);
    ...
    return treasureMapFun(currentPlayer, state, handPos);
...
int aventurerFun(int currentPlayer, struct gameState* state)
{
    //define varibles used in the function previeusly defined before the switch.
...
int stewardFun(int currentPlayer, struct gameState* state, int choice1, int choice2, int choice3 , int handPos)
{
      if (choice1 == 1)
	{
	  //+2 cards
...
int cutpurseFun(int currentPlayer, struct gameState* state, int handPos)
{
	int i;
	int j;
	int k;
...
int treasureMapFun(int currentPlayer, struct gameState* state, int handPos)
{
